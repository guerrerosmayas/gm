const tagJugadorT = '#RYLL8YLG';
const tagJugadorC = '#RYLL8YLG';
  ...
  actJugadorT.innerHTML = `
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-center" style="position: relative; display: inline-block;">
        <h2 class="fw-bold sombra-texto3 texto-fondo3"><span>????</span></h2>
        <h2 class="fw-bold dorados texto-frontal3"><span>????</span></h2>
      </div>
...
.then(datos => {
  ...
  actJugadorC.innerHTML = `
    <div class="container-fluid">
      ...
      <p>Campeón torneo Guerreros Mayas.</p>
    </div>
  `;
