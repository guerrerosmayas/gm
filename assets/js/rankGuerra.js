function rankGuerra(datos) {
    ...
    document.getElementById('tituloClasificacion').innerHTML =`<div class="row no-space w-100 text-center">
                  ...
                  if (rank == previousRank) {
                      ...
                      `<div  class="row no-space w-100 text-center" style="height: 31px;">
                          <div class="col-12 pe-0 pt-1">
                              <svg style="transform: rotate(90deg);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pause-fill" viewBox="0 0 16 16">
                      ...
                      if (previousRank < 0) {
                          ...
                          `<div class="col-12 pe-0 ">
                              <div  class="row no-space w-100 text-center" style="height: 16px;">
                                  <div class="col-12 pe-0">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill text-danger" viewBox="0 0 16 16">
                      ...
                      `<div class="col-12 pe-0 ">
                          <div  class="row no-space w-100 text-center" style="height: 16px;">
                              <div class="col-12 pe-0">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-up-fill text-success" viewBox="0 0 16 16">
                  ...
                  console.log(`Actfual:${name}, Actual: ${rank}, Anterior: ${previousRank}`);
              }
          });
}
